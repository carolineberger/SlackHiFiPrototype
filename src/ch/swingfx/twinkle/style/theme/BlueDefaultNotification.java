...
public class BlueDefaultNotification extends AbstractNotificationStyle {
	public BlueDefaultNotification() {
		super();
		...
		withAlpha(0.85f);
		withWidth(320);
		withBackground(new ColorBackground(new Color(157, 233, 255)));
